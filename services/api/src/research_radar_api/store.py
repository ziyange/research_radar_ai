...
class InMemoryStore:
    ...
    def seed(self) -> None:
        ...
        papers = [
            Paper(
                id="paper_seed_method",
                title="Open metadata example for research method discovery",
                title_zh="科研方法发现的开放元数据示例",
                year=2024,
                journal="Research Metadata Examples",
                doi="",
                authors=["Example Author"],
                abstract="A generic seed record used only for local compatibility tests.",
                keywords=["research methods", "open metadata", "literature discovery"],
                fulltext_status="open_access",
            ),
            Paper(
                id="paper_seed_review",
                title="Open metadata example for review literature",
                title_zh="综述文献开放元数据示例",
                year=2023,
                journal="Research Metadata Examples",
                doi="",
                authors=["Example Author"],
                abstract="A generic review-style seed record used only for local compatibility tests.",
                keywords=["review", "research gaps", "evidence synthesis"],
                fulltext_status="repository",
            ),
            Paper(
                id="paper_seed_application",
                title="Open metadata example for applied research",
                title_zh="应用研究开放元数据示例",
                year=2022,
                journal="Research Metadata Examples",
                doi="",
                authors=["Example Author"],
                abstract="A generic application seed record used only for local compatibility tests.",
                keywords=["application", "evaluation", "metrics"],
                fulltext_status="unknown",
            ),
            Paper(
                id="paper_seed_transfer",
                title="Open metadata example for method transfer",
                title_zh="方法迁移开放元数据示例",
                year=2024,
                journal="Research Metadata Examples",
                doi="",
                authors=["Example Author"],
                abstract="A generic seed record for method-transfer compatibility tests.",
                keywords=["method transfer", "comparison", "workflow"],
                fulltext_status="author_manuscript",
            ),
            Paper(
                id="paper_seed_gap",
                title="Open metadata example for research gap analysis",
                title_zh="研究空白开放元数据示例",
                year=2025,
                journal="Research Metadata Examples",
                doi="",
                authors=["Example Author"],
                abstract="A generic seed record for research-gap compatibility tests.",
                keywords=["research gap", "evidence", "next actions"],
                fulltext_status="open_access",
            ),
        ]
        for paper in papers:
    ...
    def create_recommendations(
        ...
        ranked_papers = [
            ("paper_seed_method", "exact", 0.92),
            ("paper_seed_review", "exact", 0.88),
            ("paper_seed_application", "exact", 0.84),
            ("paper_seed_transfer", "method_transfer", 0.8),
            ("paper_seed_gap", "method_transfer", 0.76),
        ]
        ...
        for rank, (paper_id, channel, score) in enumerate(ranked_papers, start=1):
            ...
            recommendation = Recommendation(
                ...
                rank=rank,
                explanation={
                    "topic": "命中用户研究对象或上位主题方向",
                    "method": "命中可参考的方法、评价指标或研究流程",
                    "score_basis": (
                        "主要贡献: topic="
                    ...
                    "uncertainty": "基于通用兼容样例评分，真实验收需使用评测集和人工标注。",
